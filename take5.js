    ...
    async function createSegment(inputFolder, numCameras, segmentIndex, numImagesPerSegment, finalWidth, finalHeight) {
        ...
        console.log("temppath===========", tempImagePaths.join('|'));
        await new Promise((resolve, reject) => {
            const ffmpegCommand = ffmpeg()
                ...
                .outputOptions([
                    ...
                    '-hls_list_size 0',
                    '-start_number 0',
                    '-hls_segment_filename', path.join(segmentFolder, `segment_%d.ts`)
                ])
                .output(path.join(segmentFolder, `segment_${segmentIndex}.ts`))
